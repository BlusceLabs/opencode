...
- Do not replace private `packages/opencode` imports with `@clawc/core`
...
- The package has no dependency on `opencode`, `@clawc/cli`, or
  `@clawc/core`.
...
rg '@clawc/core|packages/opencode|packages/cli' packages/tui
