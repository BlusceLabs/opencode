...
stdenvNoCC.mkDerivation (finalAttrs: {
  ...
  env.CLAWC_DISABLE_MODELS_FETCH = true;
  env.CLAWC_VERSION = finalAttrs.version;
  env.CLAWC_CHANNEL = "prod";
  ...
  doInstallCheck = true;
  versionCheckKeepEnvironment = [ "HOME" "CLAWC_DISABLE_MODELS_FETCH" ];
