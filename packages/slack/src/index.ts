...
import { createClawc, type ToolPart } from "@clawc/sdk"
...
const clawc = await createClawc({
  port: 0,
})
console.log("✅ ClawC server ready")
...
app.message(async ({ message, say }) => {
  ...
  console.log("📤 ClawC response:", JSON.stringify(result, null, 2))
