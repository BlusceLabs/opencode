...
const ButtonV2 = lazy(() => import("@clawc/ui/v2/button-v2").then((module) => ({ default: module.ButtonV2 })))
const IconV2 = lazy(() => import("@clawc/ui/v2/icon").then((module) => ({ default: module.Icon })))
