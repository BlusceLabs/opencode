...
beforeAll(async () => {
  ...
  mock.module("@clawc/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@clawc/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@clawc/ui/icon", () => ({ Icon: () => null }))
  mock.module("@clawc/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
