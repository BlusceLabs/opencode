export const dict = {
  ...
  "toast.update.description": "Une nouvelle version d'ClawC ({{version}}) est maintenant disponible pour installation.",
  ...
  "sidebar.gettingStarted.line1": "ClawC inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
