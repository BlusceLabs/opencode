...
- Effect plugins import `@clawc/plugin/v2/effect`, not `@clawc/core`.
- Public domain values use generated `@clawc/sdk` types.
...
- Define `PluginHost` domain capabilities in `@clawc/plugin/v2/effect`.
