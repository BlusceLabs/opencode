...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ ClawC:
...
- ระดับผู้ใช้ (Global): `~/.config/clawc/commands/`
- ระดับโปรเจ็กต์: `.clawc/commands/`
...
ClawC มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
