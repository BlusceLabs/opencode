---
title: Zen
description: Utvalgt liste over modeller levert av ClawC.
---
...
ClawC Zen er en liste over testede og verifiserte modeller levert av ClawC-teamet.

Zen fungerer som enhver annen leverandør i ClawC. Du logger inn på ClawC Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med ClawC.
:::
...
ClawC Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

ClawC Zen fungerer som enhver annen leverandør i ClawC.

1. Du logger inn på **<a href={console}>ClawC Zen</a>**, legger til
   faktureringsdetaljene dine og kopierer API-nøkkelen din.
2. Du kjører kommandoen `/connect` i TUI, velger ClawC Zen og limer inn API-nøkkelen din.
...
[modell-id](/docs/config/#models) i ClawC-konfigurasjonen din
bruker formatet `clawc/<model-id>`. For eksempel, for GPT 5.5, ville du
brukt `clawc/gpt-5.5` i konfigurasjonen din.
...
- DeepSeek V4 Flash Free er tilgjengelig på ClawC i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- MiMo-V2.5 Free er tilgjengelig på ClawC i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- North Mini Code Free er tilgjengelig på ClawC i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3 Ultra Free er tilgjengelig på ClawC i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på ClawC i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
...
4. Ha **ingen lock-in** ved å la deg bruke det med enhver annen kodeagent. Og alltid la deg bruke enhver annen leverandør med ClawC også.
