...
Agentferdigheter lar ClawC oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går clawc opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
clawc viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `clawc.json`:
