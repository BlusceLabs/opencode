---
title: TUI
description: Bruke clawc-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

ClawC gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre ClawC starter TUI for gjeldende katalog.
...
Når du bruker ClawC TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til ClawC. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt ClawC. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `clawc.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge ClawC venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `clawc.default`.
