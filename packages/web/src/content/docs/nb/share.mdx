---
title: Deling
description: Del dine ClawC-samtaler.
---

Delingsfunksjonen i ClawC lar deg lage offentlige lenker til dine ClawC-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Når du deler en samtale, ClawC:

1. Oppretter en unik offentlig URL for økten din
2. Synkroniserer samtaleloggen din til serverne våre
3. Gjør samtalen tilgjengelig via den delbare lenken — `clawc.ai/s/<share-id>`

---

## Deling

ClawC støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuell (standard)

Som standard bruker ClawC manuell delingsmodus. Økter deles ikke automatisk, men du kan dele dem manuelt ved å bruke kommandoen `/share`:
...
For å håndheve dette på tvers av teamet ditt for et gitt prosjekt, legg det til `clawc.json` i prosjektet ditt og sjekk det inn i Git.
...
[Finn ut mer](/docs/enterprise) om bruk av clawc i organisasjonen din.
