...
Opprett `.clawc/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom ClawC-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i ClawC [config](/docs/config):
...
ClawC inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
