---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące clawc.
---

Funkcja udostępniania clawc umożliwia tworzenie publicznych linków do konwersacji clawc, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, clawc:

1. Tworzy unikalny publiczny adres URL sesji
2. Synchronizuje historię rozmów z naszymi serwerami
3. Udostępnia rozmowę za pośrednictwem łącza do udostępniania — `clawc.ai/s/<share-id>`

---

## Udostępnianie

clawc obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie clawc korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `clawc.json` w swoim projekcie i sprawdź w Git.
...
[Dowiedz się więcej](/docs/enterprise) o używaniu clawc w Twojej organizacji.
