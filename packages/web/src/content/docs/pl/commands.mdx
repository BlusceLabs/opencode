...
Możesz zdefiniować polecenia w `clawc.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji clawc:
...
- Globalnie: `~/.config/clawc/commands/`
- Na projekt: `.clawc/commands/`
...
clawc zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
