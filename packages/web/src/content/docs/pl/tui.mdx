---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala clawc.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

clawc zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie clawc uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI clawc, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do clawc. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Jest to oddzielny plik od `clawc.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo ClawC czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `clawc.default`.
