---
title: Compartir
description: Comparte tus conversaciones ClawC.
---

La función para compartir de ClawC te permite crear enlaces públicos a tus conversaciones de ClawC, para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, ClawC:

1. Crea una URL pública única para su sesión.
2. Sincroniza tu historial de conversaciones con nuestros servidores
3. Hace que la conversación sea accesible a través del enlace para compartir: `clawc.ai/s/<share-id>`

---

## Uso compartido

ClawC admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, ClawC usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:
...
Para aplicar esto en todo su equipo para un proyecto determinado, agréguelo al `clawc.json` en su proyecto y regístrelo en Git.
...
[Obtenga más información](/docs/enterprise) sobre el uso de clawc en su organización.
