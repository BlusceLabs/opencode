...
Puede agregar comandos personalizados a través de la configuración ClawC o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su ClawC [config](/docs/config):
...
clawc incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
