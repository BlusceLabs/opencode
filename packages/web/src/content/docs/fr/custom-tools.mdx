...
description: Créez des outils que le LLM peut appeler dans clawc.
---

Les outils personnalisés sont des fonctions que vous créez et que le LLM peut appeler pendant les conversations. Ils fonctionnent avec les [outils intégrés](/docs/tools) de clawc comme `read`, `write` et `bash`.
...
- Localement en les plaçant dans le répertoire `.clawc/tools/` de votre projet.
- Ou globalement, en les plaçant dans `~/.config/clawc/tools/`.
