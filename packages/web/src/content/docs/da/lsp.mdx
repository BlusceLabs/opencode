---
title: LSP-servere
description: ClawC integreres med dine LSP-servere.
---

ClawC kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

ClawC leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `CLAWC_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og clawc åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din clawc-konfiguration.
