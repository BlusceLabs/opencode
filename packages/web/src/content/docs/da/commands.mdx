...
Du kan tilføje brugerdefinerede kommandoer gennem ClawC-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din ClawC [config](/docs/config):
...
- Globalt: `~/.config/clawc/commands/`
- Pr. projekt: `.clawc/commands/`
...
clawc indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
