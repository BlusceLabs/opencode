---
title: TUI
description: Brug af ClawC-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

ClawC giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre ClawC starter TUI for den nuværende mappe.
...
Når du bruger ClawC TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til ClawC. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Dette er adskilt fra `clawc.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe ClawC venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `clawc.default`.
