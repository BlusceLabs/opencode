---
title: Condivisione
description: Condividi le tue conversazioni ClawC.
---

La funzione di condivisione di ClawC ti permette di creare link pubblici alle tue conversazioni, cosi puoi collaborare con i colleghi o chiedere aiuto ad altre persone.
...
Quando condividi una conversazione, ClawC:

1. Crea un URL pubblico univoco per la sessione
2. Sincronizza la cronologia della conversazione sui nostri server
3. Rende la conversazione accessibile tramite il link condivisibile: `clawc.ai/s/<share-id>`

---

## Condivisione

ClawC supporta tre modalita di condivisione che controllano come vengono condivise le conversazioni:

---

### Manuale (predefinito)

Per impostazione predefinita, ClawC usa la condivisione manuale. Le sessioni non vengono condivise automaticamente, ma puoi condividerle manualmente con il comando `/share`:
...
Per applicarlo al tuo team in un progetto specifico, aggiungilo a `clawc.json` nel progetto e versionalo su Git.
...
[Scopri di piu](/docs/enterprise) su come usare clawc nella tua organizzazione.
