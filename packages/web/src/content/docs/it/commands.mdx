...
Puoi aggiungere comandi personalizzati tramite la config di ClawC o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di ClawC:
...
- Globale: `~/.config/clawc/commands/`
- Per progetto: `.clawc/commands/`
...
clawc include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
