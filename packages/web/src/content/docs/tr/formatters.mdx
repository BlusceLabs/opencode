...
description: clawc dile özgü biçimlendiriciler kullanır.
---

clawc, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

clawc, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, clawc bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

clawc bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri clawc yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
