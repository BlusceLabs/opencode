---
title: Paylasim
description: clawc konusmalarini genel baglantilarla paylasin.
---

clawc'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda clawc:

1. Oturumunuz icin benzersiz bir genel URL olusturur
2. Konusma gecmisinizi sunucularimiza senkronize eder
3. Konusmayi paylasim baglantisiyla erisilebilir hale getirir - `clawc.ai/s/<share-id>`

---

## Paylasim

clawc, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak clawc manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `clawc.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda clawc kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
