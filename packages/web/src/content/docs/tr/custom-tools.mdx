---
title: Özel Araçlar
description: LLM'un clawc'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. clawc'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.clawc/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/clawc/tools/` içine yerleştirerek.
