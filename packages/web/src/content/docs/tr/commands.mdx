...
`.clawc/commands/test.md` oluştur:
...
clawc işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

clawc [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/clawc/commands/`
- Proje başına: `.clawc/commands/`
...
clawc, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
