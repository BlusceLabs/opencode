---
title: Zen
description: clawc tarafından sağlanan seçilmiş modeller listesi.
---
...
ClawC Zen, ClawC ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, ClawC'daki diğer sağlayıcılar gibi çalışır. ClawC Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve ClawC kullanmak için buna ihtiyacınız yoktur.
...
:::tip
ClawC ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
ClawC Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

ClawC Zen, ClawC'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>ClawC Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, ClawC Zen'i seçin ve API anahtarınızı yapıştırın.
...
ClawC yapılandırmanızdaki [model id](/docs/config/#models) `clawc/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `clawc/gpt-5.5` kullanırsınız.
...
- DeepSeek V4 Flash Free, sınırlı bir süre için ClawC'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo-V2.5 Free, sınırlı bir süre için ClawC'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- North Mini Code Free, sınırlı bir süre için ClawC'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Ultra Free, sınırlı bir süre için ClawC'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için ClawC'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
ClawC Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca ClawC ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
