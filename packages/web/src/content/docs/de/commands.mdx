...
Erstellen Sie `.clawc/commands/test.md`:

```md title=".clawc/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die ClawC-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem ClawC [config](/docs/config):

```json title="clawc.jsonc" {4-12}
{
...
- Global: `~/.config/clawc/commands/`
- Pro Projekt: `.clawc/commands/`

```markdown title="~/.config/clawc/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".clawc/commands/component.md"
---
...
```md title=".clawc/commands/create-file.md"
---
...
```md title=".clawc/commands/analyze-coverage.md"
---
...
```md title=".clawc/commands/review-changes.md"
---
...
```md title=".clawc/commands/review-component.md"
---
...
ClawC enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
