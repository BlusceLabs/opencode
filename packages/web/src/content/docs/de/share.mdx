---
title: Teilen
description: Teile ClawC-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu ClawC-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht ClawC Folgendes:

1. Erstellt eine eindeutige oeffentliche URL fuer deine Sitzung
2. Synchronisiert den Verlauf auf unsere Server
3. Stellt die Unterhaltung unter `clawc.ai/s/<share-id>` bereit

---

## Teilen

ClawC hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt ClawC den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`clawc.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du clawc in deiner Organisation einsetzt.
