---
title: SDK
description: Typsicherer JS-Client fuer den clawc-Server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Das clawc JS/TS SDK bietet einen typsicheren Client fuer die Server-API.
Damit kannst du Integrationen bauen und clawc programmatisch steuern.
...
`clawc.json` wird weiterhin geladen, kann aber inline ueberschrieben oder erweitert werden:
...
Wenn clawc bereits laeuft, kannst du nur einen Client erstellen und verbinden:
