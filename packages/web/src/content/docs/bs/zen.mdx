---
title: Zen
description: Kurirana lista modela koje nudi ClawC.
---
...
ClawC Zen je lista testiranih i provjerenih modela koje pruža ClawC tim.

Zen radi kao i svaki drugi provajder u ClawC. Prijavite se na ClawC Zen i
preuzmete svoj API ključ. To je **potpuno opcionalno** i ne morate ga koristiti
da biste koristili ClawC.
...
:::tip
Testirali smo odabranu grupu modela i provajdera koji dobro rade s ClawC.
:::
...
ClawC Zen je AI gateway koji vam daje pristup tim modelima.

---

## Kako radi

ClawC Zen radi kao i svaki drugi provajder u ClawC.

1. Prijavite se na **<a href={console}>ClawC Zen</a>**, dodajte podatke za
   naplatu i kopirajte svoj API ključ.
2. Pokrenite komandu `/connect` u TUI, izaberite ClawC Zen i zalijepite svoj API ključ.
...
[model id](/docs/config/#models) u vašoj ClawC konfiguraciji koristi format
`clawc/<model-id>`. Na primjer, za GPT 5.5 u konfiguraciji biste
koristili `clawc/gpt-5.5`.
...
- DeepSeek V4 Flash Free je dostupan na ClawC ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- MiMo-V2.5 Free je dostupan na ClawC ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- North Mini Code Free je dostupan na ClawC ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Nemotron 3 Ultra Free je dostupan na ClawC ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Big Pickle je stealth model koji je besplatan na ClawC ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
...
4. Obezbijedimo **bez lock-ina** time što vam omogućavamo da ga koristite s bilo kojim drugim coding agentom. I da vam uvijek omogućimo da koristite bilo koji drugi provajder i u ClawC.
