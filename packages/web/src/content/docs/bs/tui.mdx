---
title: TUI
description: Korištenje korisničkog interfejsa ClawC terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

ClawC pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje ClawC pokreće TUI za trenutni direktorij.
...
Kada koristite ClawC TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u ClawC. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz ClawC. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `clawc.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo ClawC čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `clawc.default`.
