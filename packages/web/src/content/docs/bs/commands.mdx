...
Kreiraj `.clawc/commands/test.md`:
...
Možete dodati prilagođene komande kroz ClawC konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom ClawC [config](/docs/config):
...
- Globalno: `~/.config/clawc/commands/`
- Po projektu: `.clawc/commands/`
...
ClawC uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
