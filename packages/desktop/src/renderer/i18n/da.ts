export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af ClawC",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af ClawC er blevet downloadet. Vil du installere den og genstarte?",
