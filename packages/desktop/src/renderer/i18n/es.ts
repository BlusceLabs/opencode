export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de ClawC",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de ClawC. ¿Quieres instalarla y reiniciar?",
