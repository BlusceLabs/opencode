export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'ClawC",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'ClawC a été téléchargée. Voulez-vous l'installer et redémarrer ?",
