export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von ClawC",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von ClawC wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
