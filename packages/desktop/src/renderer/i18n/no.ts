export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av ClawC",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av ClawC er lastet ned. Vil du installere den og starte på nytt?",
