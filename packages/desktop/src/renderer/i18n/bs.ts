export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju ClawC-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} ClawC-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
