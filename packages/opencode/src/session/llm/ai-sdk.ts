import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@clawc/llm"
...
// Move this extraction into @clawc/llm when Copilot is handled by the native runtime.
