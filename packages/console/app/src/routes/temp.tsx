    ...
    <main data-page="home">
      ...
      <div data-component="content">
          ...
          <div data-slot="right">
            <button data-copy data-slot="command">
              <span>
                ...
                <span data-slot="highlight">raw.githubusercontent.com/BlusceLabs/opencode/main/install</span>
                <span> | bash</span>
              </span>
              <CopyStatus />
            </button>
        ...
        <footer data-component="footer">
          ...
          <div data-slot="cell">
            <a href="https://github.com/BlusceLabs/opencode">{i18n.t("footer.github")}</a>
          </div>
          <div data-slot="cell">
