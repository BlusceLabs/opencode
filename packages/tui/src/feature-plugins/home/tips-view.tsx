...
const TIPS: Tip[] = [
  ...
  "Create a plugin to prevent ClawC from reading sensitive files",
  ...
  "Run {highlight}clawc serve{/highlight} for headless API access to ClawC",
  ...
  "Use {highlight}/connect{/highlight} with ClawC Zen for curated, tested models",
