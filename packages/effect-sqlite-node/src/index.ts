...
export const TypeId: TypeId = "~@clawc/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@clawc/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@clawc/effect-sqlite-node/NodeSqliteClient")
